...
func TestApInbox_AcceptFollowActivity(t *testing.T) {
	...
	payload := []byte(`{"@context":"https://www.w3.org/ns/activitystreams","id":"https://wt-ap2.test/ap/users/admin#accept-follow-1","type":"Accept","actor":"https://wt-ap2.test/ap/users/admin","object":{"type":"Follow","actor":"https://wt-ap1.test/ap/users/admin","object":"https://wt-ap2.test/ap/users/admin"}}`)
